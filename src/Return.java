...
public class Return extends javax.swing.JFrame {
    ...
    public void ReturnUpdate(){
        String sql="insert into Return(Student_ID,Name,F_Name,Program,Branch,Year,Semester,Book_ID,B_Name,Edition,Publisher,Price,Pages,Date_of_Issue) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try{
        pst=conn.prepareStatement(sql);
        pst.setString(1, jTextField1.getText());
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Return Panel", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(204, 0, 51))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                ...
                //String add14=rs.getString("Date_of_Return");
